/**
 * Created by lihui on 2016/10/25.
 */
(function($,window,document,undefined){
    $.fn.bannerSwitch1= function(option){
        this.default = {
        ...
        this.cire = function(){
            ...
            var wrapBtn = $("<div class = 'live-btn1'></div>");
            ...
            me.find(".live-btn1").children().eq(0).addClass("active")//第一个按钮添加当前样式
        }

        //上一页
        this.prevBtn = function(){
            var me = this;
            var prevBtn = $("<div class='prev1'></div>");
            me.append(prevBtn);
        ...
        this.nextBtn = function(){
            var me = this;
            var nextBtn = $("<div class='next1'></div>");
            me.append(nextBtn);
        ...
        this.cireClick = function(){
            var me= this;
            $(me).find(".live-btn1").children().on("click",function(){
        ...
        this.active = function(index){
            var me = this;
            me.find(".live-btn1").children().eq(index).addClass("active").siblings().removeClass("active");
        }
        //切换图片
